...
export const Testimonials = () => {
  return (
    <section className="testi my-20" id="testimonials">
      <div className="containers">
        <Title
          title1="What Our"
          title2="Happy Clients say about us"
          text="TESTIMONIAL"
          page={true}
        />
        <p className="mt-5">
  ...
  return (
    <div className="box shadow-s2 p-8 rounded-lg relative">
      ...
      <p className="py-7 italic leading-7">
        ...
        id eum, neque odio omnis doloribus laudantium, ullam autem consequatur
        obcaecati, voluptatibus quod nesciunt.
      </p>
