...
import { options, type TValue } from "../utils";
            ...
            <div className="flex justify-between flex-wrap lg:flex-nowrap gap-5">
              <div className="lg:w-2/3 w-full">
                <div className="buttons flexc gap-5 flex-wrap lg:flex-nowrap">
                  ...
                  <Button
                    text="Write a review"
                    icon={<MdOutlineModeComment size={15} />}
                  />
                  <Button text="Share" icon={<FaShareAlt size={15} />} />
                  <Button
                    text="Report"
                    icon={<TbMessageReportFilled size={15} />}
                  />
                </div>
...
export const TripImg = ({ img, desc }: TripImgProps) => {
  return (
    <Card>
      ...
      <p className="py-2">
        From eight till twelve he worked at his trade. From twelve to one he
        read or overlooked his accounts and dined. From two to five he worked at
        his trade. The rest of the evening until 10 he spent in music, or
        diversion of some sort. This time is used also to put things in their
        places. In the last thing before retiring was examination of the day. At
        the age of 79, he ascribed his health to temperance; the acquisition of
        misfortune to industry and frugality;
      </p>
      <p>{desc}</p>
    </Card>
  );
...
export const TripRating = ({ rating }: TripRatingProps) => {
  return (
    <Card>
      ...
      <div className="flexc justify-between bg-slate-900 p-4 rounded-md">
        <div className="flexc gap-2 text-white text-sm">
          <span className="bg-green-500 text-xs rounded-md p-1 border">
            {rating}
          </span>
          <span>12 Rating</span>
        </div>
    ...
    <Card>
      ...
      <section className="booking-accordion">
        {booking.map((item) => (
          <div
            key={item.id}
            className={`mb-6 ${activeId === item.id ? "active" : ""}`}
          >
            {/* Accordion header */}
            <div
              className="relative z-10 flex gap-2 cursor-pointer"
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pt-4">
          <div className="">
            ...
            <input
              type="text"
              className="w-full p-2 mt-2 border border-slate-300 rounded-md outline-none"
    ...
    <Card>
      ...
      <div>
        ...
        <p className="font-semibold text-black">
          Phone:{" "}
          <span className="font-normal text-gray-500">(123) 345-6789</span>
        </p>
