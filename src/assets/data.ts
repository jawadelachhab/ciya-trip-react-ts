export const NavLists = [
  { id: 1, text: "Home", path: "/",  },
  { id: 3, text: "Tours", path: "/#tours"},
  { id: 4, text: "Tour plan", path: "/#tour-plan"},
  { id: 6, text: "Testimonials", path: "/#testimonials" },
  { id: 5, text: "Contact", path: "/contact" },
];
export const paper = "../images/title-icon.png";
export const flag0 = "../images/country-flags/01.jpg";
export const flag1 = "../images/country-flags/06.jpg";
export const flag2 = "../images/country-flags/02.jpg";
export const flag3 = "../images/country-flags/03.jpg";
export const flag4 = "../images/country-flags/04.jpg";
export const flag5 = "../images/country-flags/05.jpg";
...
export const avatar = "../images/listing-brand/01.png";
...
export const trips = [
  {
    ...
    price: "$899",
    discount: "$700",
    avatar: "https://themes.potenzaglobalsolutions.com/html/ciyatrip/images/listing-brand/01.png",
    desc: "The bottom line is that we must shed the bad and replace with good beliefs.",
    rating: "4 / 5",
  },
  {
    id: 2,
    ...
    price: "$550",
    discount: "$750",
    avatar: "https://themes.potenzaglobalsolutions.com/html/ciyatrip/images/listing-brand/02.png",
    desc: "The bottom line is that we must shed the bad and replace with good beliefs.",
    rating: "4.3 / 5",
  },
  {
    ...
    price: "$399",
    discount: "$350",
    avatar: "https://themes.potenzaglobalsolutions.com/html/ciyatrip/images/listing-brand/03.png",
    desc: "The price is something not necessarily defined as financial.",
    rating: "4.3 / 5",
  },
  {
    id: 4,
    ...
    discount: "",
    avatar: "https://themes.potenzaglobalsolutions.com/html/ciyatrip/images/listing-brand/03.png",
    desc: "We all carry a lot of baggage, thanks to our upbringing.",
    rating: "4.3 / 5",
  },
  {
    id: 5,
    ...
    discount: "",
    avatar: "https://themes.potenzaglobalsolutions.com/html/ciyatrip/images/listing-brand/02.png",
    desc: "Step out on to the path to your left. Where there is no change.",
    rating: "4.3 / 5",
  },
  {
    id: 6,
    ...
    discount: "",
    avatar: "https://themes.potenzaglobalsolutions.com/html/ciyatrip/images/listing-brand/01.png",
    desc: "Briefly imagine that you are not going to live and discover your unfulfilled dreams.",
    rating: "4.3 / 5",
  },
];
